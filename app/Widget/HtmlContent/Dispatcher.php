...
/**
 * Класс \cs\Widget\HtmlContent\Dispatcher
...
class Dispatcher implements DispatcherInterface
{
    ...
    public static function cron($isEcho = true)
    {
        ...
        $path = Yii::getAlias('@upload/' . HtmlContent::$uploadFolder);
        Yii::info('Зачистака временной папки: ' . $path, 'cs\Widget\HtmlContent\Dispatcher::cron');
        if (file_exists($path)) {
