...
<div class="container">
<div class="col-lg-12">
<h1 class="page-header">Карта Жизни Гражданина Галактики <small><span class="glyphicon glyphicon-question-sign buttonInfo" role="button"></span></small></h1>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Гороскоп - карта, или изображение небес, составленная для даты, времени и места вашего рождения. Положение Солнца, Луны, планет, а также знак над горизонтом размещаются по кольцу Зодиака и раскрывают сложные математические взаимосвязи, рисующие вашу персональную схему и потенциал развития. Эта карта раскрывает ваши физические, ментальные, эмоциональные и духовные способности и затруднения, и вы всегда вольны расти и меняться по своему собственному желанию.
                </p>
                <p>
                    Примечательны также точки пересечения траекторий Земли и Луны, образующие так называемые голову и хвост небесного дракона, или северный и южный узлы лунной орбиты. Расположение «небесного дракона» на карте чрезвычайно значимо, поскольку оно указывает направление, в котором вы движетесь, достигая исполнения предначертанной вам цели, а также то место в прошлом, где вы изначально возникли. Поскольку вы родились в физической реальности, ваша жизнь несет на себе отпечаток космической энергии, воплощающей план ваших целей и намерений, план, составленный и утвержденный вами лично.
                </p>
                <p>
                    В анналах творения Земля рассматривается как монументальный архив точной информации, живая библиотека, хранящая множество слоев генетических кодов ее органической жизни. Ваша наука с большим энтузиазмом стремится разгадать генетические коды жизни, не понимая, где и как возник этот великолепный порядок. Вы - наследники звезд.
                </p>
                <p>
                    Как часто ваш взгляд устремлялся в ночное небо? Сколько вопросов и молитв вознесли вы к небесному своду? Сколько раз вы пересчитывали звезды или размышляли об энергии Солнца? Ваши глубочайшие внутренние желания - это закономерные вибрации воспоминаний, стремящихся разгореться и пробудиться, вновь стать едиными с непрерывной целью, охватывающей весь Космос. Вы пришли на Землю, чтобы закрепить это древнее знание в человеческом облике, зная, что жизнь здесь преподносит столько возможностей и даров, сколько вы способны выбрать, чтобы пережить их.
                </p>
                <p>
    ...
    <div class="panel-body">
        ...
        <?php } else { ?>
            <?php if (!Yii::$app->user->isGuest) { ?>
                ...
                <?php } else { ?>
                    <p class="alert alert-success">Нет данных</p>
                    <a href="https://vk.com/id313579738" target="_blank" class="btn btn-default btn-xs">Узнать свое</a>
                <?php } ?>
            <?php } else { ?>
                <p class="alert alert-success">Нет данных</p>
                <a href="https://vk.com/id313579738" target="_blank" class="btn btn-default btn-xs">Узнать свое</a>
