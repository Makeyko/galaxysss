...
<div class="container">
    ...
    <div class="row">
        ...
        <p>
            Номер печати Антипода = N+/-I0, если печать с 0 (20) по 10, то «+10», а если с 11 по 19, то «-10»; </p>
        ...
        <p>
            НООСФЕРНОЕ ВРЕМЯ. Согласно Закону Времени, время, как принцип четвёртого измерения, является фрактальным,
